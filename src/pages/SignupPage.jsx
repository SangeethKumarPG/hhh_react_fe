...
export default function SignupPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (signupUser.fulfilled.match(result)) {
      ...
      alert("Error: " + JSON.stringify(result.payload));
    }
  };

  return (
    <div className="container" style={{width:"100%", maxWidth:"400px", padding:"30px 20px", boxShadow:"0 0 20px rgba(0,0,0,0.05)", borderRadius:"12px", textAlign:"center"}}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <p className="switch">I'm already a member? <a href="/login">Sign In</a></p>
      </form>
